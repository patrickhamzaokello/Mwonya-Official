...
$sqlalbum = "SELECT id, title From albums WHERE tag='poem'";
//ordeer
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form enctype="multipart/form-data" method="post" id="upload_form">
            ...
            <div class="form-group">
                <label for="songAlbum">Poem Collection</label>
                <select name="albumselect" id="songAlbum" required class="form-control">
                    <option selected>Poem Collection</option>
            ...
            <div class="form-group">
                <label for="songGenre">Poem Genre</label>
                <select id="songGenre" required class="form-control">
                    <option selected>Choose Poem Genre</option>
