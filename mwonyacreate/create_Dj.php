...
<body>
    <nav class="navbar  navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="create_Dj.php">Create DJ</a>
                </li>
    ...
    <div class="container mt-5">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="mb-3">
            <h3 class="text-center mb-5">New Mwonya DJ</h3>
            ...
            <div class="tagname">
                <input name="tagname" value="dj">Tag: <Span
                    style="background: #7b4888;    padding: 5px;    color: white;">DJ</Span></p>
            </div>
