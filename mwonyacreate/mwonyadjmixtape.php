...
$sqlalbum = "SELECT id, title From albums WHERE tag='dj'";
//ordeer
...
<body>
    ...
    <nav class="navbar  navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item ">
                    <a class="nav-link active" href="">Mixtape </a>
                </li>
    ...
    <div class="container mt-5">
        ...
        <form enctype="multipart/form-data" method="post" id="upload_form">
            ...
            <div class="form-group">
                <label for="songAlbum">Mixtape Collection</label>
                <select name="albumselect" id="songAlbum" required class="form-control">
                    <option selected>Mixtape Collection</option>
            ...
            <div class="form-group">
                <label for="songGenre">Mixtape Genre</label>
                <select id="songGenre" required class="form-control">
                    <option selected>Choose Mixtape Genre</option>
