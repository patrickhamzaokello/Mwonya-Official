...
<body>
    <nav class="navbar  navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="create_poems.php">Create Poem Album</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-5">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="mb-3">
            <h3 class="text-center mb-5">New Mwonya Poem</h3>
            ...
            <div class="tagname">
                <input name="tagname" value="poem">Tag: <Span
                    style="background: #7b4888;    padding: 5px;    color: white;">Poem</Span></p>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="AlbumTitle" class="form-control" id="exampleInputEmail1"
                    aria-describedby="nameHelp" placeholder="Enter Poem Name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea type="textarea" name="description" class="form-control" id="exampleInputdescription"
                    aria-describedby="descriptionHelp" placeholder="Poem Description"></textarea>
            </div>
