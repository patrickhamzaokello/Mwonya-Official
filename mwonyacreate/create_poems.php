...
$sqlartist = "SELECT id, name FROM artists WHERE tag='poem'";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a class="nav-link" href="create_poems.php">Create Poem Album</a></li>
                    <li> <a class="nav-link" href="create_Dj.php">Create DJ</a></li>
                </ul>
    ...
    <div class="container mt-5">
        <div class="cards">
            ...
            <form action="" method="post" enctype="multipart/form-data" class="mb-3">
                <h3 class="text-center mb-5">New Mwonya Poem Collection</h3>



                <div class="tagname">
                    <input name="tagname" value="poem">Tag: <Span style="background: #7b4888;    padding: 5px;    color: white;">Poem</Span></p>
                </div>


                <div class="form-group">
                    <label for="exampleInputEmail1">Poem Title</label>
                    <input type="text" name="AlbumTitle" class="form-control" id="exampleInputEmail1" aria-describedby="nameHelp" placeholder="Enter Poem Name">
                </div>
                <div class="form-group">
                    <label for="inputState">Poem Creator</label>
                ...
                <div class="form-group">
                    <label for="inputState">Poem Genre</label>
                ...
                <div class="form-group">
                    <label for="exampleInputdescription">Poem Description</label>
                    <textarea type="textarea" name="description" class="form-control" id="exampleInputdescription" aria-describedby="descriptionHelp" placeholder="Poem Description"></textarea>
                </div>

                <div class="form-group">

                    <div class="custom-file">
                        <label class="custom-file-label" for="chooseFile">Select Poem Cover</label>
