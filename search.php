...
<div class="overview__albums">
    ...
    <div class="overview__albums__head">
        ...
        <span class="section-title">Dj Mixtapes</span>
    ...
    $songsQuery = mysqli_query($con, "SELECT id FROM songs WHERE title LIKE '%$term%' AND tag ='dj' LIMIT 10");

    if (mysqli_num_rows($songsQuery) == 0) {
        echo "<span class='noResults'>No Mixtapes found matching: " . $term . "</span>";
    } else {
...
<div class="overview__albums">
    ...
    <div class="overview__albums__head">
        ...
        <span class="section-title">Poems Results</span>
    ...
    $songsQuery = mysqli_query($con, "SELECT id FROM songs WHERE title LIKE '%$term%' AND tag ='poem' LIMIT 10");

    if (mysqli_num_rows($songsQuery) == 0) {
        echo "<span class='noResults'>No Poems found matching: " . $term . "</span>";
    } else {
