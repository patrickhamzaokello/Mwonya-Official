                ...
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            ...
                            <div class="hero-cta"><a class="button button-primary" href="register.php">Create
                                    Account</a><a class="button" href="register.php">Get in touch</a></div>
                        </div>
                                ...
                                <div class="pricing-table-inner is-revealing">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header pb-24">
                                            <div class="pricing-table-price"><span
                                                    class="pricing-table-price-currency h2">UGX</span><span
                                                    class="pricing-table-price-amount h1"> 20,000</span><span
                                    ...
                                    <div class="pricing-table-cta mb-8">
                                        <a class="button button-primary button-shadow button-block"
                                            href="register.php">Buy Package now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
